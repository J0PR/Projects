...
f='conmedfv'; tr=0; mvx=1; %parameters for Levenberg-Marquardt method:
tolf=1e-4;                 %f : a function to evaluate the vector ff of 
                           %    individual functions such that ff'*ff is
                           %    minimized 
maxit=100; nu0=.01;               
jac=1; prt=2;              %tr: >0 x is passed from marqdt to f but not
...
vgam=str.vgam;  bind=str.bind; [nbind,mbind]=size(bind);
...
str3 = param2sse(str3);  
%store results
str.phiscon=str3.phis; str.thetascon=str3.thetas; str.gammascon=str3.gammas;
str.phitvcon=str3.phitv; str.thetatvcon=str3.thetatv; str.gammatvcon=str3.gammatv;
str.muscon=str3.mu; str.mutvcon=str3.mutv;
str.phistcon=str3.phist; str.thetastcon=str3.thetast; str.gammastcon=str3.gammast;
str.Fscon=str3.Fs; str.Kscon=str3.Ks; str.Bscon=str3.Bs; str.Dscon=str3.Ds;
str.Hscon=str3.Hs;
