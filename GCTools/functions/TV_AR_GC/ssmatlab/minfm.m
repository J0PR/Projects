...
%     mvx : parameter used only for toolbox ARIMA. It can be empty.
...
%     inc : parameter used only for toolbox ARIMA. It can be empty.
%
...
infm.f=f; infm.tr=tr; infm.mvx=mvx;      
infm.tolf=tolf; infm.maxit=maxit; 
infm.nu0=nu0; infm.jac=jac; 
infm.prt=prt; infm.chb=chb; infm.inc=inc;
