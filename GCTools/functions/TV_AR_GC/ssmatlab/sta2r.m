...
stre=str; 
stre.thetas=str.thetas; stre.sigmar2=str.sigmar2;
stre.vgams=str.vgams;stre.phis=str.phis; stre.gammas=str.gammas;
...
str.phis=stre.phis; str.sigmar2=stre.sigmar2;
str.nonst2=0; 
str.Fs=stre.Fs; str.Hs=stre.Hs; str.Ks=stre.Ks; 
% insert new parameters in beta and vgams
vgams=stre.vgams; bind=str.bind;  
[nbind,mbind]=size(bind); beta=zeros(nbind,1);
for i=1:nbind
 beta(i) = vgams(bind(i));
end
str.beta=beta; str.vgams=vgams;
%obtain new armax parameters (phi(1)=I, theta(1)=I).
[phist,thetast,gammast,ierror] = armaxe2armax(str.phis,...
                                    str.thetas,str.gammas);
str.phist=phist; str.thetast=thetast; str.gammast=gammast;
