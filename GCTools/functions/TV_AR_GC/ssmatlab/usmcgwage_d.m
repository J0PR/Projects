...
% Date: 31.12.2011
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% This Matlab script generates cycle of the German GDP real wage, 
% seasonally adjusted, in the framework of a structural time series model
% It includes a function to perform boostrap in the way described by
% Stoffer and Wall (1998) and also a function to deterct auxiliary
% residuals.
%
...
% figure
% tsplot(recrs, datei, 'CWage(STSM) St. Residuals');
% pause
...
pause
% saveas(gcf, 'results\GWage_STSM','fig');
...
dist = {'irreg','slope'};
cw= 1.96;
fname='results\Aux_res_GWage.txt';
fid = fopen(fname,'w');
tname='GDP real wage';
