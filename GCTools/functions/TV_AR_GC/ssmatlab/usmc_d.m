...
comp.freq=freq;
bg_year=1770; bg_per=1; datei = cal(bg_year,bg_per,freq); 
comp.datei=datei;
...
trend=Xt(:,1); cycle=Xt(:,2);
%forecast of trend
trendp=alpr(1,:)'; cyclep=alpr(2,:)';
names=strvcat('Original Series with forecasts','Trend with forecasts');
tsplot([[yor; pry'] [trend; trendp]],datei,names);
pause
