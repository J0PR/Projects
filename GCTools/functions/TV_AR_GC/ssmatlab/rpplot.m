...
t=1:n;
subplot(2,1,1)
plot(t,zeros(1,n)); legend(fname); hold on
for i=1:n
 c1=i*ones(1,n); c2=0:r(i)/(n-1):r(i);
 plot(c1,c2); hold on
end
plot(t,c*sea,'r'); hold on; plot(t,-c*sea,'r');
...
plot(t,zeros(1,n)); legend(fname); hold on
for i=1:n
 c1=i*ones(1,n); c2=0:p(i)/(n-1):p(i);
 plot(c1,c2); hold on
end
plot(t,c*sep,'r'); hold on; plot(t,-c*sep,'r');
