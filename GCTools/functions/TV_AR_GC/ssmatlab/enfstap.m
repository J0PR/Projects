...
if any(krob - kro)
 phie=phi; thetae=theta; Sigmab=Sigmai; 
 ...
 phie=phieb; thetae=thetaeb;
end

stre=str; stre.phis=phie; stre.thetas=thetae; stre.gammas=str.gamma;
stre.npar=str.npar; stre.s=str.s; stre.kro=str.kro; stre.m=str.m;
stre = armaxe2sse(stre);
Kb=stre.Ks; phib=stre.phis; Fb=stre.Fs; Hb=stre.Hs;

str.Kb=Kb; str.Sigmab=pinv(Sigmab); str.phib=phie; str.Fb=Fb; 
str.thetab=thetae; str.Hb=Hb;
% str.Kb
% str.Sigmab
% % str.phib
