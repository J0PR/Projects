function [F,e,g,M,Pevf,A,P] = smfun(xx,y,s,pfix,pvar,xf,chb,models)
%*************************************************************************
...
models.freq=s; models.pfix=pfix; models.pvar=pvar;
[X,Z,G,W,T,H,ins,i,ferror] = pr2usm(xx,xf,models);
