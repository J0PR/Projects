...
stre=str; 
stre.thetas=str.thetas3; stre.sigmar2=str.sigmar3;
stre.vgams=str.vgams3;stre.phis=str.phis3; stre.gammas=str.gammas3;
%add the following line if first option in enfstab
stre.Fs=str.Fs3; stre.Hs=str.Hs3; stre.Ks=str.Ks3;
%make the model stationary 
vgams=enfstab(stre,'phi  '); 
stre.vgams=vgams; stre = param2sse(stre); 

%stre=stamodel(stre);

str.phis3=stre.phis; str.sigmar3=stre.sigmar2;
str.nonst3=0; 
str.Fs3=stre.Fs; str.Hs3=stre.Hs; str.Ks3=stre.Ks; 
% insert new parameters in beta3 and vgams3
bind=str.bind; [nbind,mbind]=size(bind); beta=zeros(nbind,1);
for i=1:nbind
 beta(i) = vgams(bind(i));
end
str.beta3=beta; str.vgams3=vgams;
...
str.phist3=phist3; str.thetast3=thetast3; str.gammast3=gammast3;
