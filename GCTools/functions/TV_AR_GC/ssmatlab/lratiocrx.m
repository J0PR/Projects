...
% PURPOSE: performs likelihood ratio test for varx model
...
if maxlag < minlag
 disp('maxlag < minlag in lrratiocrx');
 return
end;
...
%Reinsel's correction, p.107
 nbrofvar2=neqs+nx; nbrofvar1=nbrofvar2*(i-1)+1;
...
resid1 = varx_res(y,0,x); initresa(1,:)=resid1(1,:);  
