...
str.nonsta=1;
 ...
 stre.kro=kro; stre.phi=str.phis; stre.theta=str.thetas; 
 stre.npar=str.npar; %stre.gamma=str.gamma; stre.gammas=str.gammas;
 stre.gamma=str.gammas;
 stre.s=s; stre.m=str.m; stre.kro=str.kro; %stre.vgam=str.vgam;
...
%  maxmodarc=max(abs(eig(stre.Fb))); str.maxmodarc=maxmodarc; 
 ...
 % change estimates
 str.sigmar2=stre.Sigmab; str.phis=stre.phib;  str.thetas=stre.thetab;
