...
phis=str.phis; thetas= str.thetas; gammas=str.gammas; 
npar=str.npar; s=str.s; kro=str.kro; nx=str.m;
...
Ks=zeros(sk,s); Ds=zeros(s,nx); Bs=zeros(sk,nx);
if nlag > 0                                         
