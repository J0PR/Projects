...
npr=n+r; np1=n+1; tn=2*n; tnpr=tn+r;
%matrix Tm
Tm=eye(npr); K=zeros(n,r);
K(1:r,1:r)=eye(r); nk=0;
for i=1:r
 nkn=nk+n-i;
...
%matrix Gm
Gmu=zeros(n,npr);
models.Tm=Tm; models.Hm=Hmu; models.Zm=Zm; models.Gm=Gmu; 
models.W=[]; models.X=[];

models.T=Tm; models.H=Hm; models.Z=Zm; models.G=Gm; models.W=[]; 
models.X=[]; models.i=im; models.ins=insm; models.stord=stord; 
models.conc=conc;
