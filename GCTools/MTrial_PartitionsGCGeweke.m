function [outPartitionsGGC,freqStruct] = MTrial_PartitionsGCGeweke(X,Nr,Nl,Fs,NLAGS,freqs)
...
outPartitionsGGC=GewekeGCPartitions(X,Xs.B,Xs.A,Xs.C,NLAGS,freqs,Fs);
